...
ssize_t ReedSolomon::decode_ccsds(uint8_t *data) {
...
ssize_t ReedSolomon::decode_rs8(uint8_t *data) {
    uint8_t odata[255];
...
void ReedSolomon::deinterleave(const uint8_t *data, uint8_t *output, uint8_t pos, uint8_t I) {
    for (size_t i = 0; i < 255; i++) {
        output[i] = data[i * I + pos];
    }
}

void ReedSolomon::interleave(const uint8_t *data, uint8_t *output, uint8_t pos, uint8_t I) {
