...
#ifndef LEANHRPT_VITERBI_VITERBI_H
...
// r=3/4 k=7 punctured viterbi with automatic phase/shift detection
class Viterbi {
    public:
        Viterbi(float ber_threshold, size_t outsync_after);
        Viterbi(float ber_threshold, size_t outsync_after, bool fengyun_mode);
        ~Viterbi();
